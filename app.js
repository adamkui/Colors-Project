...
function closedjustmentPanel(index){
...
//Implement save to palette and locol storage stuff
...
function savedPalette(){
    ...
    //const paletteObj = {name: name}  <-- As the name equals the parameter name we can simply write name as in below line
